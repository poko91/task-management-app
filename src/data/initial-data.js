const initialData = {
  tasks: {
    ...
    "task-4": { id: "task-4", title: "Fix bugs in the CSS code", content: "Fix small bugs that are essential to prepare for the next release that will happen this quarter.", due_date: "2023-12-10", priority: "Low" },
  },
  columns: {
    "column-1": {
      id: "column-1",
